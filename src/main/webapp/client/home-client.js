...
$(document).on('click', '#inputStringPost', function () {
    'use strict';
    let post = '<form class=\"form-group\" action=\"../AddUserTextPost\" method=\"post\">' +
...
$(document).on('click', '#inputImg', function () {
    'use strict';
    let post = '<form class=\"form-group\" action=\"../AddUserImgPost\" method=\"post\" enctype=\"multipart/form-data\">\n' +
