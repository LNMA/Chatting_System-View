            ...
            <div class="col-1 mt-2 mb-2 ">
                ...
                <div class="list-group" role="tablist" style="height: 40em; width: 18em; overflow: auto">
                    ...
                    <form action="<%=contextPath%>/ViewReceiveMessageContent" method="get">
                        ...
                        <input type="text" name="senderUser" value="${set.getSourceUser().getUsername()}" readonly hidden>
                ...
                <div class="tab-content" id="nav-tabContent">
                    <div style="height: 55em;overflow: auto">
                        ...
                        <p class="text-muted small">
                            ${notSee.getNumOfNotSeen()} message ${notSee.getSourceUser().getFirstName()} ${notSee.getSourceUser().getLastName()} not see it.
                        </p>
                        </c:forEach>
                    ...
                    <form action="<%= contextPath %>/SendMessage" method="post">
                        <input type="text" name="targetUser" value="<c:out value="${sender}"/>" readonly hidden>
