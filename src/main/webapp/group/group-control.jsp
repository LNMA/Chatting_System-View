...
<main class="container-fluid" style="padding-top: 13em;">
                            ...
                            <div class="row row-cols-md-2">
                                ...
                                <div class="col-md-10">
                                    <form action="<%=contextPath%>/client/review-account.jsp" method="get">
                                        <input type="text" value="${group.value.getGroup().getIdGroup()}" name="strange"
                                               hidden readonly>
                                        <input type="text" value="${group.value.getGroup().getAccountType()}"
                                               name="type" hidden readonly>
                                        <button class="btn btn-block" type="submit">
                                            <div class="row">
                                                <img src="data:img/png;base64,${group.value.getGroup().getBase64()}"
                                                     width="94" height="94" class="rounded-circle">
                                                <p class="font-weight-bold ml-3"
                                                   style="margin-top: 4%;">${group.value.getGroup().getIdGroup()}</p>
                                            </div>
                                        </button>
                                    </form>
                                </div>
                                ...
                                <div class="col-md-2" style="margin-top: 4%;">
                                    <form action="<%=contextPath%>/SwitchToGroup" method="post">
                                        <input type="text" name="idGroup" value="${group.value.getGroup().getIdGroup()}"
                                               hidden readonly>
                                        <input type="text" name="memberType" value="${group.value.getGroupMemberType()}"
                                               hidden readonly>
