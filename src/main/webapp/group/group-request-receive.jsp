                    ...
                    <div class="card-body">
                            <div class="form-row">
                                ...
                                <form class="col-10" action="<%=contextPath%>/client/review-account.jsp" method="get">
                                    <input type="text" value="${request.value.getTargetAccount().getUsername()}" name="strange" readonly hidden>
                                    <input type="text" value="${request.value.getTargetAccount().getAccountType()}" name="type" readonly hidden>
                                    <button class="btn btn-block" type="submit">
                                        <div class="form-row">
                                            <div class="col-1">
                                                <img src="data:image/png;base64,${request.value.getTargetAccount().getBase64()}" class="rounded-circle" width="128" height="128">
                                            </div>
                                            <div class="col-10">
